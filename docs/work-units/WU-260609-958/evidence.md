...
- Reports:
- `docs/work-units/WU-260609-958/assignment.md`
- `docs/work-units/WU-260609-958/claim.md`
- `docs/work-units/WU-260609-958/progress.jsonl`
- `docs/work-units/WU-260609-958/visibility-proof.jsonl`
- Sources:
- `README.md`
...
- Latest controlled live evidence found in the repo is
  `docs/work-units/WU-260609-907`: `evidence.md` is Result Ready,
...
- Checked the latest live controlled evidence in
  `docs/work-units/WU-260609-907/evidence.md`,
  `docs/work-units/WU-260609-907/decision.md`, and
  `docs/work-units/WU-260609-907/visibility-proof.jsonl`.
...
- Working tree status is not clean at HEAD `5f3a20f`: `git status --short`
  reports untracked `docs/work-units/WU-260609-958-handoff-spec.json`,
  untracked `docs/work-units/WU-260609-958/`, and untracked
