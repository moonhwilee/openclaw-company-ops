...
- Assignment Packet: `docs/work-units/WU-260609-906/assignment.md`
...
- Sources:
  ...
  - `docs/work-units/WU-260609-906/assignment.md`
  - `docs/work-units/WU-260609-906/progress.jsonl`
  - `docs/work-units/WU-260609-906/visibility-proof.jsonl`
  - `docs/work-units/WU-260609-906/dispatch.json`
- Generated artifacts:
  - `docs/work-units/WU-260609-906/evidence.md`
- Test output:
...
- Read `docs/work-units/WU-260609-906/assignment.md` before
  execution.
...
- Read `docs/operations-manual.md` and mapped the checklist to canonical
  ...
  closeout rules.
- Checked `docs/work-units/WU-260609-906/progress.jsonl`,
