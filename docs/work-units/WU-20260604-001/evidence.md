...
- Assignment Packet:
  `docs/work-units/WU-20260604-001/assignment.md`
...
- PR: documentation PR for `codex/work-units-operations-manual`
- Test output:
...
- Generated artifacts:
  ...
  - `docs/work-units/WU-20260604-001/assignment.md`
  - `docs/work-units/WU-20260604-001/claim.md`
  - `docs/work-units/WU-20260604-001/evidence.md`
  - `docs/work-units/WU-20260604-001/decision.md`
  - `docs/operations-manual.md`
