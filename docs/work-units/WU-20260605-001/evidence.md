...
- Assignment Packet: `docs/work-units/WU-20260605-001/assignment.md`
...
- Smoke artifacts:
  - `docs/work-units/WU-20260605-001/assignment.md`
  - `docs/work-units/WU-20260605-001/claim.md`
  - `docs/work-units/WU-20260605-001/evidence.md`
...
- Criterion: A live read-only `build-lab` smoke run records packet-first
  ...
  - Evidence: first `build-lab` run blocked on missing packet; second run read
    ...
    `docs/work-units/WU-20260605-001/assignment.md`, executed
