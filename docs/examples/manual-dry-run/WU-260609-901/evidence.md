...
- Generated artifacts:
- Generated artifacts:
  `docs/examples/manual-dry-run/WU-260609-901/visibility-proof.jsonl`
...
- Review notes: `git status --short` checked before result-ready. Existing
  ...
  `docs/examples/manual-dry-run/WU-260609-901/`,
  `docs/examples/manual-dry-run/WU-260609-902/`, and `scripts/__pycache__/`.
...
- Published RESULT_READY through
  ...
  `--work-unit-id WU-260609-901`, `--artifact-root docs/examples/manual-dry-run`,
  and `--source-ref docs/examples/manual-dry-run/WU-260609-901/evidence.md`.
...
- Criterion: Evidence explicitly confirms no code or docs were modified by the
  ...
  - Evidence: No code files or non-Work-Unit docs were modified. The only
    ...
    Record: `docs/examples/manual-dry-run/WU-260609-901/evidence.md`.
...
- Criterion: Team Lead submits result-ready only through the source-backed
  ...
  - Evidence: Published through the source-backed result-ready command with
    source ref `docs/examples/manual-dry-run/WU-260609-901/evidence.md`.
    Readback proof:
    `WU-260609-901:team-detail:RESULT_READY:6d9abae22d1829a1`.
