...
- Claim ref: `CLAIM-WU-260609-901-001`
...
- Expected until:
- Last claim: `build-lab` started work. Source: `docs/examples/manual-dry-run/WU-260609-901/assignment.md`.
...
- Evidence ref: `docs/examples/manual-dry-run/WU-260609-901/evidence.md`
- Operations Lead decision ref: `docs/examples/manual-dry-run/WU-260609-901/decision.md`
