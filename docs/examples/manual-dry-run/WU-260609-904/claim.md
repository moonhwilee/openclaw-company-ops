...
- Expected until:
- Last claim: `revenue` started work. Source: `docs/examples/manual-dry-run/WU-260609-904/assignment.md`.
...
- Evidence ref: `docs/examples/manual-dry-run/WU-260609-904/evidence.md`
- Operations Lead decision ref: `docs/examples/manual-dry-run/WU-260609-904/decision.md`
