...
- Assignment Packet: `docs/examples/manual-dry-run/WU-260608-004/assignment.md`
- Evidence ref: `docs/examples/manual-dry-run/WU-260608-004/evidence.md`
- Operations Lead decision ref: `docs/examples/manual-dry-run/WU-260608-004/decision.md`
...
- Result-ready evidence: `docs/examples/manual-dry-run/WU-260608-004/evidence.md`
