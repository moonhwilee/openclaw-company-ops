...
- Sources: `README.md`, `docs/operations-manual.md`,
  ...
  `docs/examples/manual-dry-run/WU-260609-903/dispatch.json`,
  `docs/examples/manual-dry-run/WU-260609-903/progress.jsonl`,
  `docs/examples/manual-dry-run/WU-260609-903/visibility-proof.jsonl`.
- Screenshots:
- Generated artifacts:
- Review notes:
...
- Read assignment packet before execution:
  `docs/examples/manual-dry-run/WU-260609-903/assignment.md`.
