...
- Claim ref: `CLAIM-WU-260609-903-001`
...
- Updated at: `2026-06-09T02:54:03Z`

## Expected Responsibility

- Expected state: `working`
- Expected until:
- Last claim: `build-lab` started work. Source: `docs/examples/manual-dry-run/WU-260609-903/assignment.md`.
...
- Assignment Packet: `docs/examples/manual-dry-run/WU-260609-903/assignment.md`
- Evidence ref: `docs/examples/manual-dry-run/WU-260609-903/evidence.md`
- Operations Lead decision ref: `docs/examples/manual-dry-run/WU-260609-903/decision.md`
