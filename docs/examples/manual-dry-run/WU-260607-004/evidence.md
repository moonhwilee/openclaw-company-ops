...
- Reports:
  - Team Lead verify result:
    `docs/examples/manual-dry-run/WU-260607-004/team-lead-result.md`
- Sources:
  - Assignment Packet:
    `docs/examples/manual-dry-run/WU-260607-004/assignment.md`
  - Progress log:
    `docs/examples/manual-dry-run/WU-260607-004/progress.jsonl`
  - Discord visibility proof:
    `docs/examples/manual-dry-run/WU-260607-004/visibility-proof.jsonl`
  - GitHub Work Card:
