...
- Evidence ref: `docs/examples/manual-dry-run/WU-260607-004/evidence.md`
- Operations Lead decision ref: `docs/examples/manual-dry-run/WU-260607-004/decision.md`
