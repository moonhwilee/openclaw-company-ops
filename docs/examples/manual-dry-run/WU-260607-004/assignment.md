...
- Work Card: https://github.com/moonhwilee/openclaw-company-ops/issues/23
- Assignment Packet: `docs/examples/manual-dry-run/WU-260607-004/assignment.md`
- Claim: `docs/examples/manual-dry-run/WU-260607-004/claim.md`
- Evidence draft: `docs/examples/manual-dry-run/WU-260607-004/evidence.md`
- Decision draft: `docs/examples/manual-dry-run/WU-260607-004/decision.md`
...
- Evidence & Result Record:
  `docs/examples/manual-dry-run/WU-260607-004/evidence.md`
