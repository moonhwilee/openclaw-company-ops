...
- Assignment Packet: `docs/examples/manual-dry-run/WU-260609-905/assignment.md`
...
- Sources:
  ...
  - `docs/examples/manual-dry-run/WU-260609-905/assignment.md`
  - `docs/examples/manual-dry-run/WU-260609-905/claim.md`
  - `docs/examples/manual-dry-run/WU-260609-905/progress.jsonl`
  - `docs/examples/manual-dry-run/WU-260609-905/visibility-proof.jsonl`
  - `docs/examples/manual-dry-run/WU-260609-905/dispatch.json`
- Screenshots:
- Generated artifacts:
- Review notes:
