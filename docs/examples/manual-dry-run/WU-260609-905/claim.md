...
- Expected until:
- Last claim: `build-lab` started work. Source: `docs/examples/manual-dry-run/WU-260609-905/assignment.md`.
...
- Evidence ref: `docs/examples/manual-dry-run/WU-260609-905/evidence.md`
- Operations Lead decision ref: `docs/examples/manual-dry-run/WU-260609-905/decision.md`
